...
function ProductCard({ product, cartItems, fetchCartItems, alertModalSetter }) {
    ...
    const [buttonSpinner, setButtonSpinner] = useState(false) //This state is used to show a spinner when the user adds or removes an item from the cart
        ...
        <Fragment>
            < div key={product.id} className=" w-80 shadow-lg flex flex-col ">
                ...
                <div className="w-full  flex justify-center mt-2 mb-2">
                    <button type='button' className=" bg-yellow-500  font-medium rounded-lg pl-2 pr-2 pt-1 h-8 flex flex-row place-content-center gap-1" onClick={() => {
                        ...
                        {buttonSpinner && <div>
                            <svg aria-hidden="true" className=" w-7 h-6  text-gray-200 animate-spin dark:text-gray-600 fill-gray-900" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
